CREATE TABLE F_Type (
    F_Type_ID INTEGER PRIMARY KEY AUTOINCREMENT ,
    F_Type_Name VARCHAR NOT NULL
);

CREATE TABLE F_Maker (
    F_Maker_ID INTEGER PRIMARY KEY AUTOINCREMENT,
    F_Maker_Name VARCHAR NOT NULL
);

CREATE TABLE F_Set (
    F_Set_ID INTEGER PRIMARY KEY AUTOINCREMENT,
    F_Set_Name VARCHAR NOT NULL
);

CREATE TABLE F_Material (
    F_Material_ID INTEGER PRIMARY KEY AUTOINCREMENT,
    F_Material_Name VARCHAR NOT NULL
);

CREATE TABLE F_Entity (
    F_Entity_ID INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE F_Sales (
    F_Sales_ID INTEGER PRIMARY KEY AUTOINCREMENT,
